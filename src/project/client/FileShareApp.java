...
public class FileShareApp extends JFrame
{
	...
	private FileShareApp(String initialhost, int initialport)
	{
		peer = new Client();
	...
	private void updateFileList() {
		...
		if(peer.getWatcher() != null){
			for (String filename : peer.getWatcher().getFiles().keySet()) {
	...
	public static void main(String[] args) throws IOException
	{
		...
		new FileShareApp("localhost", 9001);
